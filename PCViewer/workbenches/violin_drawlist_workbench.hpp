...
public:
    ...
    std::vector<structures::const_attribute_info_ref>       get_active_ordered_attributes() const;
    std::map<std::string_view, structures::min_max<float>>  get_attribute_min_max() const;
};
}