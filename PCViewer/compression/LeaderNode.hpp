...
public:
    ...
    void cacheNode(CacheManagerInterface& cacheManager, const std::string& parentId, float* parentCenter, float parentEps, HierarchyCreateNode* chacheNode){throw std::runtime_error{"Cache manager not supported for leader node"};};
    size_t getByteSize();
