...
bool decodeRLHuffHalf(GpuInstance* pInstance, const RLHuffDecodeDataCpu& decodeDataCpu, const RLHuffDecodeDataGpu& decodDataGpu, VkDeviceAddress outSymbols, VkCommandBuffer commands, TimingQuery timingInfo = {});
