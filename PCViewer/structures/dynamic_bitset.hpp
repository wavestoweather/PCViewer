...
//
// File was adopted in 2022 by Josef Stumfpegger, original version can be found at https://github.com/pinam45/dynamic_bitset
 ...
 * @since      1.0.0
 */
namespace structures //sul changed for better inclusion into the project
{
#endif
